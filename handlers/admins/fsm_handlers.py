...
async def dyn_reply_content_handler(m: types.Message, state: FSMContext):
    ...
    content = m.html_text # Use html_text to preserve formatting
...
# (All other handlers for /admin panel are here, correct and unchanged, omitted for brevity)
# ... channel handlers, broadcast, ui handlers, etc. ...
...
def register_fsm_handlers(dp: Dispatcher):
    ...
    # ... (all other /admin registrations are here, correct and unchanged, omitted for brevity) ...
